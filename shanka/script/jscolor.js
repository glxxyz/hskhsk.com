...
var jscolor = {
	...
	color : function(target, prop) {
        ...
        this.pickerisGoddamActive = false; // only set to TRUE when this picker is god damned actually active
        this.currentlyFingImporting = false; // set to TRUE when we are F-ing Importing a colour        
