/*
    Shanka HSK Flashcards - lang_french.js version 1
...
this. this_switch_language              = "Switch Language to FrenchinFrench";

/* These strings describe all currently supported languages */
this. lang_interface_language           = "Switch Language inFrench";
this. lang_dutch_language               = "DutchinFrench";
this. lang_english_language             = "EnglishinFrench";
this. lang_french_language              = "FrenchinFrench";
this. lang_italian_language             = "ItalianinFrench";
this. lang_spanish_language             = "SpanishinFrench";
