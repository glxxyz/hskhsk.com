...
build_word_graph("HSK1_words" + ext,    hsk1words,  hsk_components)
build_word_graph("HSK2_words" + ext,    hsk2words,  hsk_components)
build_word_graph("HSK3_words" + ext,    hsk3words,  hsk_components)
build_word_graph("HSK4_words" + ext,    hsk4words,  hsk_components)
build_word_graph("HSK5_words" + ext,    hsk5words,  hsk_components)
build_word_graph("HSK6_words" + ext,    hsk6words,  hsk_components)
build_word_graph("HSK1-2_words" + ext, hsk12words, hsk_components)
build_word_graph("HSK1-3_words" + ext, hsk13words, hsk_components)
build_word_graph("HSK1-4_words" + ext, hsk14words, hsk_components)
build_word_graph("HSK1-5_words" + ext, hsk15words, hsk_components)
build_word_graph("HSK1-6_words" + ext, hsk16words, hsk_components)
build_word_graph("HSK2-3_words" + ext, hsk23words, hsk_components)
build_word_graph("HSK2-4_words" + ext, hsk24words, hsk_components)
build_word_graph("HSK2-5_words" + ext, hsk25words, hsk_components)
build_word_graph("HSK2-6_words" + ext, hsk26words, hsk_components)
build_word_graph("HSK3-4_words" + ext, hsk34words, hsk_components)
build_word_graph("HSK3-5_words" + ext, hsk35words, hsk_components)
build_word_graph("HSK3-6_words" + ext, hsk36words, hsk_components)
build_word_graph("HSK4-5_words" + ext, hsk45words, hsk_components)
build_word_graph("HSK4-6_words" + ext, hsk46words, hsk_components)
build_word_graph("HSK5-6_words" + ext, hsk56words, hsk_components)

build_char_graph("HSK1_chars" + ext,    hsk1chars,  cc_components)
build_char_graph("HSK2_chars" + ext,    hsk2chars,  cc_components)
build_char_graph("HSK3_chars" + ext,    hsk3chars,  cc_components)
build_char_graph("HSK4_chars" + ext,    hsk4chars,  cc_components)
build_char_graph("HSK5_chars" + ext,    hsk5chars,  cc_components)
build_char_graph("HSK6_chars" + ext,    hsk6chars,  cc_components)
build_char_graph("HSK1-2_chars" + ext, hsk12chars, cc_components)
build_char_graph("HSK1-3_chars" + ext, hsk13chars, cc_components)
build_char_graph("HSK1-4_chars" + ext, hsk14chars, cc_components)
build_char_graph("HSK1-5_chars" + ext, hsk15chars, cc_components)
build_char_graph("HSK1-6_chars" + ext, hsk16chars, cc_components)
build_char_graph("HSK2-3_chars" + ext, hsk23chars, cc_components)
build_char_graph("HSK2-4_chars" + ext, hsk24chars, cc_components)
build_char_graph("HSK2-5_chars" + ext, hsk25chars, cc_components)
build_char_graph("HSK2-6_chars" + ext, hsk26chars, cc_components)
build_char_graph("HSK3-4_chars" + ext, hsk34chars, cc_components)
build_char_graph("HSK3-5_chars" + ext, hsk35chars, cc_components)
build_char_graph("HSK3-6_chars" + ext, hsk36chars, cc_components)
build_char_graph("HSK4-5_chars" + ext, hsk45chars, cc_components)
build_char_graph("HSK4-6_chars" + ext, hsk46chars, cc_components)
build_char_graph("HSK5-6_chars" + ext, hsk56chars, cc_components)
