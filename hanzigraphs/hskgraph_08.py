...
def build_word_graph(filename, nodes, edgeslist, hskmin, hskmax):
    ...
    outedges = set()
    foundorphans = {}
    graph = GEXFGraph(filename.split(".")[0])
    for node in nodes:
...
def build_star_graph_older(filename, nodes):
...
# new version which applies frequency distance and random angle
...
#newer version with increasing distance and increasing angle
...
if False:
    add_pinyin_to_svg("svg/HSK1_wordchar_v08.svg")
    add_pinyin_to_svg("svg/HSK1_words_v08.svg")
    add_pinyin_to_svg("svg/HSK1-2_words_v08.svg")
    add_pinyin_to_svg("svg/HSK1-3_words_v08.svg")
    add_pinyin_to_svg("svg/HSK1-6_wordstar_v08.svg")
    add_pinyin_to_svg("svg/HSK1-6_wordstar_v07 with swirls.svg")

# convert previously created SVG file to traditional
if False:
    convert_simp_to_trad_svg("svg/HSK1_wordchar_v08.svg")
    convert_simp_to_trad_svg("svg/HSK1_words_v08.svg")
    convert_simp_to_trad_svg("svg/HSK1-2_words_v08.svg")
    convert_simp_to_trad_svg("svg/HSK1-3_words_v08.svg")
    convert_simp_to_trad_svg("svg/HSK1-6_wordstar_v08.svg")
    convert_simp_to_trad_svg("svg/HSK1-6_wordstar_v07 with swirls.svg")
    
    convert_simp_to_trad_svg("svg/HSK1_wordchar_v08_pinyin.svg")
    convert_simp_to_trad_svg("svg/HSK1_words_v08_pinyin.svg")
    convert_simp_to_trad_svg("svg/HSK1-2_words_v08_pinyin.svg")
    convert_simp_to_trad_svg("svg/HSK1-3_words_v08_pinyin.svg")
    convert_simp_to_trad_svg("svg/HSK1-6_wordstar_v08_pinyin.svg")
    convert_simp_to_trad_svg("svg/HSK1-6_wordstar_v07 with swirls_pinyin.svg")
